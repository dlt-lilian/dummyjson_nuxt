import{l as h,q as m,ag as x,ah as k,g as p,a0 as y,R as N,a6 as S,ai as v,aj as C}from"./CnS3tyO8.js";const z=Object.freeze({left:0,top:0,width:16,height:16}),I=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),w=Object.freeze({...z,...I});Object.freeze({...w,body:"",hidden:!1});function q(e,t){let s=e.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const n in t)s+=" "+n+'="'+t[n]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+s+">"+e+"</svg>"}const R=/(-?[0-9.]*[0-9]+[0-9.]*)/g,$=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function j(e,t,s){if(t===1)return e;s=s||100;const n=e.split(R);if(n===null||!n.length)return e;const c=[];let r=n.shift(),l=$.test(r);for(;;){if(l){const o=parseFloat(r);isNaN(o)?c.push(r):c.push(Math.ceil(o*t*s)/s)}else c.push(r);if(r=n.shift(),r===void 0)return c.join("");l=!l}}function P(e){return e.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function T(e){return"data:image/svg+xml,"+P(e)}function A(e){return'url("'+T(e)+'")'}function F(e){if(e.width!==e.height){const t=Math.max(e.width,e.height);return{...e,width:t,height:t,left:e.left-(t-e.width)/2,top:e.top-(t-e.height)/2}}return e}function L(e){const t={display:"inline-block",width:"1em",height:"1em"},s=e.varName;switch(e.pseudoSelector&&(t.content="''"),e.mode){case"background":s&&(t["background-image"]="var(--"+s+")"),t["background-repeat"]="no-repeat",t["background-size"]="100% 100%";break;case"mask":t["background-color"]="currentColor",s&&(t["mask-image"]=t["-webkit-mask-image"]="var(--"+s+")"),t["mask-repeat"]=t["-webkit-mask-repeat"]="no-repeat",t["mask-size"]=t["-webkit-mask-size"]="100% 100%";break}return t}function O(e,t){const s={},n=t.varName;e.width!==e.height&&(t.forceSquare?e=F(e):s.width=j("1em",e.width/e.height));const c=q(e.body.replace(/currentColor/g,t.color||"black"),{viewBox:`${e.left} ${e.top} ${e.width} ${e.height}`,width:e.width.toString(),height:e.height.toString()}),r=A(c);if(n)s["--"+n]=r;else switch(t.mode){case"background":s["background-image"]=r;break;case"mask":s["mask-image"]=s["-webkit-mask-image"]=r;break}return s}const g={selectorStart:{compressed:"{",compact:" {",expanded:" {"},selectorEnd:{compressed:"}",compact:`; }
`,expanded:`;
}
